		...
		<?php if(isset($blog[0]['name']) || isset($ssblog[0]['name'])) { ?>
			...
			<section class="container-fluid">
				<?php if( isset($ssblog[0]['cover']) && !empty($ssblog[0]['cover']) ) { ?>
					<div class="row relativer bg-container bg-mh bg-widget-cover appear" style="background-image: url('<?= $this->urlTo('uploads/'.$ssblog[0]['cover']) ?>')"> </div>
				<?php } else { ?>
						...
						<div class="col-md-10">
							<?php if( isset($ssblog[0]['video']) ) { ?>
								<div class="play-container blog-play-container">
									<img class="play-ico" src="<?= $this->urlTo('assets/img/play-13.svg') ?>" alt="PlayIco">
									<img class="custom-thumbnail img-fluid d-block m-auto" src="<?= $this->urlTo('uploads/'.$ssblog[0]['img']) ?>" alt="<?php echo $ssblog[0]['img_alt'] ?>">
							...
							<?php } else { ?>
								<img class="img-fluid d-block m-auto" src="<?= $this->urlTo('uploads/'.$ssblog[0]['img']) ?>" alt="<?php echo $ssblog[0]['img_alt'] ?>">
							<?php } ?>
				...
				<div class="container-custom py-60">
					<div class="row">
						<div class="col-md-6 offset-md-3 text-center">
							<img src="<?= $this->urlTo('assets/img/logo-34.svg') ?>" alt="logo">
						</div>
						<div class="col-md-12 text-center mt-5">
							...
							<?php
								...
								echo $this->insert('widgets/categories',$cat_compact);
							?>
						</div>
						<?php
							...
							<?php foreach( $blogs as $blog ) { ?>
								<?php if( $b_counter==0 ) { ?>
									<div class="col-md-7 text-center mt-60 mb-3 mb-md-5">
										<div class="row justify-content-center">
											<div class="col-md-12">
												<img class="img-fluid d-block" src="<?= $this->urlTo('uploads/'.$blog['img']) ?>" alt="<?php echo $blog['img_alt'] ?>">
											</div>
										</div>
									</div>
	...
	<?php
		...
		<?php }
				...
				<div class="col-md-12 mb-3">
					<div class="row justify-content-center">
						<div class="col-md-6">
							<form action="<?= $this->urlTo('php/db/requests.php') ?>" method="POST">
